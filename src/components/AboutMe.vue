...
<template>
    <div class="text-sm sm:text-3xl md:text-2xl text-blue-200 font-mono">
        ...
        <ul class="list-none pl-0">
            ...
            <li class="pb-2">
                <span style="color:#79c7ba">println!</span>(<span style="color: #fc4640;">"A guy who lives in Brazil 🇧🇷"</span>);
            </li>
            <li class="pb-2">
            ...
            <li class="pb-2">
                <span style="color:#79c7ba">println!</span>(<span style="color: #fc4640;">"Wanna explore the universe 🔭"</span>);
            </li>
        </ul>
    </div>
</template>

<template>
    <a href="https://github.com/ShawnNectar" target="_blank" class="inline-block">
        <svg xmlns="http://www.w3.org/2000/svg" :class="iconClasses" viewBox="0 0 24 24" :fill="iconColor">

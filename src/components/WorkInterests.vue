...
<template>
    <div class="text-sm sm:text-3xl md:text-2xl text-blue-200 font-mono">
        ...
        <h2 class="pb-2">
            <span style="color:#79c7ba">println!</span>(<span style="color: #FC4640FF;">"IoT technology 📡 <br class="md:hidden"/>## I've been working on home automation"</span>);
        </h2>
        <h2 class="pb-2">
            <span style="color:#79c7ba">println!</span>(<span style="color: #FC4640FF;">"Robotics 🤖 <br class="md:hidden"/>## I love anything related to robotics LOVE IT"</span>);
        </h2>
        <h2 class="pb-2">
